...
!(function (o) {
    ...
    (o.modal = function (t, i) {
        ...
        (o.modal.prototype = {
            ...
            unblock: function (t) {
                !t && this.options.doFade
                    ...
                    : (this.$blocker.children().appendTo(this.$body), this.$blocker.remove(), (this.$blocker = null), n(), o.modal.isActive() || this.$body.css("overflow", ""), this.$html.css("overflowY", ""));
            },
            show: function () {
        ...
        (o.modal.close = function (t) {
            if (o.modal.isActive()) {
            	// popUserOrgList를 버그를 잡기위해 하기위해 20201201 정성훈
            	$("#commModalGigwan").addClass("close");
                t && t.preventDefault();
                var i = l();
