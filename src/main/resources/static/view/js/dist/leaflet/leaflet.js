...
!(function (t, i) {
        ...
        le = k.extend({
            ...
            _onDown: function (t) {
                if (
                    ...
                    this._enabled &&
                    ((this._moved = !1),
                    !di(this._element, "leaflet-zoom-anim") && !(le._dragging || t.shiftKey || (1 !== t.which && 1 !== t.button && !t.touches) || ((le._dragging = this)._preventOutline && zi(this._element), bi(), $t(), this._moving)))
                ) {
                    this.fire("down");
    ...
    var we,
        ...
        ze = h({}, U, { code: "EPSG:3395", projection: be, transformation: ((we = 0.5 / (Math.PI * be.R)), K(we, 0.5, -we, 0.5)) }),
